...
def kBET_single(
    ...
    ro.globalenv["k0"] = k0
    batch_estimate = ro.r(
        f"batch.estimate <- kBET(data_mtrx, batch, k0=k0, plot=FALSE, do.pca=FALSE)"
    )
...
def calulate_ari_nmi(adata_integrated, n_cluster=4):
    ...
    print(
        "louvain clustering result(resolution={}):n_cluster={}".format(reso, n_cluster)
    )
    print("ARI:", ARI)
    print("NMI:", NMI)
    return ARI, NMI
...
def evaluate_dataset(adata_integrated, method="louvain1.0", n_celltype=10):
    ...
    print(
        "..............................calculate ari nmi according to nceltype={}...........................".format(
            n_celltype
        )
    )
    ...
    sil_global = silhouette(
        adata_integrated, group_key=label_key, embed=embed, metric=si_metric
    )
